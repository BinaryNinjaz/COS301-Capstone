...
public final class OrchardInFarmRow: OptionsRow<PushSelectorCell<Orchard>>, PresenterRowType, RowType {
  ...
  public required init(tag: String?) {
    ...
    presentationMode = .show(
      controllerProvider: ControllerProvider.callback {
        ...
        evc.entity = EntityItem.orchard(evc.row.value ?? Orchard(json: [:], id: ""))
        return evc
      },
