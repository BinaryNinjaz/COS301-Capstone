...
\label{webTracker}
The Tracker page can be found at any time by clicking on the \texttt{Tracker} button in the navbar. Once clicked on, the user will be taken to the Tracker, as seen in 11. It serves simply by providing an updating feed of the farm and the locations of foremen every two minutes.
