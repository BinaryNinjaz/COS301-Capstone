...
\label{webHome}
Once the user has logged in, they will be taken to the home page, as seen in \ref{HomePage}. The home page is the starting point of the system, it serves simply by providing links to the rest of the website.
...
The Analytics on the website can be seen in \ref{webStatsImg}. \\
