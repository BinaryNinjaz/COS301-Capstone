...
\begin{figure}[h]
 \centering
 \includegraphics[width=6cm, keepaspectratio]{Images/signupIOS.png}
 \caption{Sign Up Mobile Form}
 \label{SignUpMobile}
\end{figure}

\subsubsection{Logging In}
When on the log in screen enter your email and its password you used to create the account, alternatively click log in with Google to use Google credentials if they have been linked with Harvest. If you have already logged in the app will keep you logged in until you log out.
\begin{figure}[h]
 \centering
 \includegraphics[width=6cm, keepaspectratio]{Images/loginIOS.png}
 \caption{Log In Mobile Form}
 \label{LogInMobile}
\end{figure}
...
\paragraph{Heatmap}Takes the user to the heatmap page, as seen in 
\ref{HeatMap}.
\paragraph{Sign Out}Logs the user out of the system, and returns them to the login page, as seen in 
\ref{LoginPage}
...
\begin{figure}
 \centering
 \includegraphics[width=12cm, keepaspectratio]{Images/heatMapWeb.png}
 \caption{Heat Map}
 \label{HeatMap}
\end{figure}
