...
\center{\textbf{Introduction}\\ 
	\flushleft{
The goal of the project is to design and develop a software system to be used by the farming community in the facilitation and management farming. We will be designing and developing Harvest, a software application for Android and iOS smartphones/tablets as well as a website.
\newline\newline}
