...
\item[$\bullet$]The Web interface shall accepts detailed information about produce. (e.g. cultivar, year planted)
...
\item[$\bullet$]The harvest website shall give the farmer/administrator a real time map view of foremen's locations.
